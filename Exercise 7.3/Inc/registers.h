...
/* -----------------------------------------------------------------------
 * Timer registers (RM0316 Section 21)
 * --------------------------------------------------------------------- */
typedef struct {
    reg32 CR1;
    reg32 CR2;
...
/* -----------------------------------------------------------------------
 * USART registers (RM0316 Section 29)
 * --------------------------------------------------------------------- */
typedef struct {
    reg32 CR1;
    reg32 CR2;
...
/* -----------------------------------------------------------------------
 * I2C registers (RM0316 Section 28)
 * --------------------------------------------------------------------- */
typedef struct {
    reg32 CR1;
    reg32 CR2;
...
/* -----------------------------------------------------------------------
 * USART CR1 bits (RM0316 Section 29)
 * --------------------------------------------------------------------- */
...
/* -----------------------------------------------------------------------
 * USART ISR bits (RM0316 Section 29)
 * --------------------------------------------------------------------- */
...
#define USART_ISR_FE_Msk  USART_ISR_FE
#define USART_ISR_ORE_Msk USART_ISR_ORE

/* -----------------------------------------------------------------------
 * USART ICR bits (RM0316 Section 29)
 * --------------------------------------------------------------------- */
